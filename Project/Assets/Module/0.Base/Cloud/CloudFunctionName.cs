...
public class CloudFunctionNames
{
    ...
    //微信
    public const string F_WECHAT_GET_OPENID = "F_WECHAT_GET_OPEN_ID";
    public const string F_WECHAT_IOS_IAP_ORFER = "F_WECHAT_IOS_IAP_OFFER";
    public const string F_WECHAT_TEXT_INSPECT = "F_WECHAT_TEXT_INSPECT";
    // 其他函数名可以继续定义...
}
...
public class CloudFunctionAPI
{
    ...
    {
        { CloudFunctionNames.F_TOKEN, "https://token-dcdn.onicore.host/space_token"},
        ...
        {CloudFunctionNames.F_ACCOUNT, "https://space-dcdn.onicore.host/account"},
        {CloudFunctionNames.F_PROGRESS_SYNC, "https://space-dcdn.onicore.host/progress"},
        {CloudFunctionNames.F_MAIL, "https://space-dcdn.onicore.host/mail"},
        {CloudFunctionNames.F_GROUP_AB, "https://space-dcdn.onicore.host/config_trigger"},
        {CloudFunctionNames.F_LEVEL, "https://space-dcdn.onicore.host/config_level"},
        {CloudFunctionNames.F_ACCESS, "https://space-dcdn.onicore.host/access"},
        {CloudFunctionNames.F_TEST, "https://space-dcdn.onicore.host/test"},
    };

...
{
    [System.Serializable]
    public class RTSGridWorld : GridGraph<RTSGridNode>
    {
        private FlowField flowField;
        public RTSGridWorld(float nodeWidth, Vector2Int gridXY, int offsetX, int offsetY) : base(nodeWidth, gridXY, offsetX, offsetY)
        {
        ...
        protected override internal void OnNodeUpdated(Dictionary<Vector2Int, RTSGridNode> nodeDict)
        {

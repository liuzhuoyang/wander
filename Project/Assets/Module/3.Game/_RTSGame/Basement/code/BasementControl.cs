...
namespace RTSDemo.Basement
{
    public class BasementControl : Singleton<BasementControl>
    {
        ...
        public void CreateBasement(string basementKey, Vector2Int lbPoint, Vector2Int gridSize)
        {
            ...
            Vector2 lbPos = RTSGridWorldSystem.Instance.GetWorldPosFromGrid(lbPoint - Vector2Int.one);
            Vector2 rtPos = RTSGridWorldSystem.Instance.GetWorldPosFromGrid(new Vector2Int(maxX, maxY) + Vector2Int.one);
        ...
        {
            float halfCell = RTSGridWorldSystem.Instance.GetGridWidth() * 0.5f;
            // 添加左上角的墙体
            if (!DictWallGridCoord.ContainsKey(new Vector2Int(basementRect.xMin, basementRect.yMax)))
            {
                CreateViewObject(basementKey, basementRect.xMin, basementRect.yMax, RTSGridWorldSystem.Instance.GetGridNode(basementRect.xMin, basementRect.yMax).worldPos + new Vector2(-halfCell, halfCell),
            ...
            for (int y = basementRect.yMax; y >= basementRect.yMin; y--)
            {
                ...
                {
                    CreateViewObject(basementKey, basementRect.xMin, y, RTSGridWorldSystem.Instance.GetGridNode(basementRect.xMin, y).worldPos + new Vector2(-halfCell * 2, 0),
            ...
            {
                CreateViewObject(basementKey, basementRect.xMin, basementRect.yMin, RTSGridWorldSystem.Instance.GetGridNode(basementRect.xMin, basementRect.yMin).worldPos + new Vector2(-halfCell, -halfCell),
            ...
            for (int x = basementRect.xMin; x <= basementRect.xMax; x++)
            {
                ...
                {
                    CreateViewObject(basementKey, x, basementRect.yMin, RTSGridWorldSystem.Instance.GetGridNode(x, basementRect.yMin).worldPos + new Vector2(0, -halfCell * 2),
            ...
            {
                CreateViewObject(basementKey, basementRect.xMax, basementRect.yMin, RTSGridWorldSystem.Instance.GetGridNode(basementRect.xMax, basementRect.yMin).worldPos + new Vector2(halfCell, -halfCell),
            ...
            for (int y = basementRect.yMin; y <= basementRect.yMax; y++)
            {
                ...
                {
                    CreateViewObject(basementKey, basementRect.xMax, y, RTSGridWorldSystem.Instance.GetGridNode(basementRect.xMax, y).worldPos + new Vector2(halfCell * 2, 0),
            ...
            {
                CreateViewObject(basementKey, basementRect.xMax, basementRect.yMax, RTSGridWorldSystem.Instance.GetGridNode(basementRect.xMax, basementRect.yMax).worldPos + new Vector2(halfCell, halfCell),
            ...
            for (int x = basementRect.xMax; x >= basementRect.xMin; x--)
            {
                ...
                {
                    CreateViewObject(basementKey, x, basementRect.yMax, RTSGridWorldSystem.Instance.GetGridNode(x, basementRect.yMax).worldPos + new Vector2(0, halfCell * 2),

...
namespace BattleLaunch
{
    ...
    {
        public readonly Launchable_SO launchableData;
    ...
    {
        private readonly Launchable_SO launchable_SO;
        ...
        public BattleLaunchCommand_Direct(Launchable_SO launchable_SO, AttackData attackData, Transform launchTrans, IBattleActor target)
        {
